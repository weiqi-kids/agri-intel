...
class TaiferFetcher(CompanyFetcher):
    """台灣肥料 爬蟲"""

    company_id = "taifer"
    company_name = "台灣肥料"
    news_url = "https://www.台灣肥料.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from 台灣肥料")
        return documents
