...
class YaraFetcher(CompanyFetcher):
    """Yara International 爬蟲"""

    company_id = "yara"
    company_name = "Yara International"
    news_url = "https://www.yarainternational.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.yarainternational.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Yara International")
        return documents
