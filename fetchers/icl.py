...
class IclFetcher(CompanyFetcher):
    """ICL Group 爬蟲"""

    company_id = "icl"
    company_name = "ICL Group"
    news_url = "https://www.iclgroup.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.iclgroup.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from ICL Group")
        return documents
