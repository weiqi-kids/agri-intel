...
class AgcoFetcher(CompanyFetcher):
    """AGCO Corporation 爬蟲"""

    company_id = "agco"
    company_name = "AGCO Corporation"
    news_url = "https://www.agcocorporation.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.agcocorporation.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from AGCO Corporation")
        return documents
