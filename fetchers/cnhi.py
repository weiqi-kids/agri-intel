...
class CnhiFetcher(CompanyFetcher):
    """CNH Industrial 爬蟲"""

    company_id = "cnhi"
    company_name = "CNH Industrial"
    news_url = "https://www.cnhindustrial.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.cnhindustrial.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from CNH Industrial")
        return documents
