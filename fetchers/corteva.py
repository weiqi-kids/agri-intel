...
class CortevaFetcher(CompanyFetcher):
    """Corteva Agriscience 爬蟲"""

    company_id = "corteva"
    company_name = "Corteva Agriscience"
    news_url = "https://www.cortevaagriscience.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.cortevaagriscience.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Corteva Agriscience")
        return documents
