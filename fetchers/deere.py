...
class DeereFetcher(CompanyFetcher):
    """Deere & Company 爬蟲"""

    company_id = "deere"
    company_name = "Deere & Company"
    news_url = "https://www.deere&company.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.deere&company.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Deere & Company")
        return documents
