"""
Sociedad Química y Minera 官網爬蟲
"""
...
class SqmFetcher(CompanyFetcher):
    """Sociedad Química y Minera 爬蟲"""

    company_id = "sqm"
    company_name = "Sociedad Química y Minera"
    news_url = "https://www.sociedadquímicayminera.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.sociedadquímicayminera.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Sociedad Química y Minera")
        return documents
