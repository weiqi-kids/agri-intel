...
class CfIndustriesFetcher(CompanyFetcher):
    """CF Industries 爬蟲"""

    company_id = "cf_industries"
    company_name = "CF Industries"
    news_url = "https://www.cfindustries.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.cfindustries.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from CF Industries")
        return documents
