...
class FmcFetcher(CompanyFetcher):
    """FMC Corporation 爬蟲"""

    company_id = "fmc"
    company_name = "FMC Corporation"
    news_url = "https://www.fmccorporation.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.fmccorporation.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from FMC Corporation")
        return documents
