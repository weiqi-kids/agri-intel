...
class MosaicFetcher(CompanyFetcher):
    """The Mosaic Company 爬蟲"""

    company_id = "mosaic"
    company_name = "The Mosaic Company"
    news_url = "https://www.themosaiccompany.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.themosaiccompany.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from The Mosaic Company")
        return documents
