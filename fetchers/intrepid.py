...
class IntrepidFetcher(CompanyFetcher):
    """Intrepid Potash 爬蟲"""

    company_id = "intrepid"
    company_name = "Intrepid Potash"
    news_url = "https://www.intrepidpotash.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.intrepidpotash.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Intrepid Potash")
        return documents
