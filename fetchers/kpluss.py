...
class KplussFetcher(CompanyFetcher):
    """K+S AG 爬蟲"""

    company_id = "kpluss"
    company_name = "K+S AG"
    news_url = "https://www.k+sag.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from K+S AG")
        return documents
