...
class NutrienFetcher(CompanyFetcher):
    """Nutrien 爬蟲"""

    company_id = "nutrien"
    company_name = "Nutrien"
    news_url = "https://www.nutrien.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from Nutrien")
        return documents
