...
class OciFetcher(CompanyFetcher):
    """OCI N.V. 爬蟲"""

    company_id = "oci"
    company_name = "OCI N.V."
    news_url = "https://www.ocinv.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from OCI N.V.")
        return documents
