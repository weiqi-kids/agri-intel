...
class KubotaFetcher(CompanyFetcher):
    """Kubota Corporation 爬蟲"""

    company_id = "kubota"
    company_name = "Kubota Corporation"
    news_url = "https://www.kubotacorporation.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.kubotacorporation.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Kubota Corporation")
        return documents
